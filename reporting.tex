...
\usepackage{gitinfo2}
%\lohead*{Peter Musterheinzel} \rohead*{Seitenstile mit \KOMAScript}
%\lohead{Peter Musterheinzel} 
%\rohead{Seitenstile mit \KOMAScript} 
%\lofoot[Verlag Naseblau, NIrgendwo] {Verlag Naseblau, NIrgendwo}
\cfoot[Git-Hash: \gitAbbrevHash ] {Git-Hash: \gitAbbrevHash } 
%\rehead{Peter Musterheinzel} 
%\lehead{Seitenstile mit \KOMAScript} 
%\refoot[Verlag Naseblau, Irgendwo] {Verlag Naseblau, Irgendwo} 
\setkomafont{pageheadfoot}{\small} 
\setkomafont{pagehead}{\bfseries}
%\cefoot{Git-Hash: \gitAbbrevHash }
